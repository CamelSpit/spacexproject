...
export default class Survey extends Component{
                ...
                axios.get('/api/surveyresults').then(
                    res=>{
                       ...
                       for (var k in temp){
                        ...
                        console.log("about to setstate for iq");
                        this.setState({
                            iq: iq,
                            educationlvl: temp,
    ...
    submit(){
        ...
        if (this.state.userType==="currentUser"){
            ...
            axios.post('/api/survey', body).then(res=>{ //it was important that this not have http://localhost:3020. It needs to use the proxy in order to keep the cookie. 
                console.log(res.data);
                this.props.history.push('/profile');
            })}
    }
    ...
    render(){
        console.log("on render", this.state.iq)
        return (
